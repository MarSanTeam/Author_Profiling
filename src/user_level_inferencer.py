...
from utils import create_user_embedding
...
if __name__ == "__main__":
    ...
    TRAIN_USER_EMBEDDINGS, TRAIN_USER_LABEL = create_user_embedding(TRAIN_DATA, MODEL, TOKENIZER)
    logging.debug("Create train user embeddings")

    VAL_USER_EMBEDDINGS, VAL_USER_LABEL = create_user_embedding(VAL_DATA, MODEL, TOKENIZER)
    logging.debug("Create validation user embeddings")

    TEST_USER_EMBEDDINGS, TEST_USER_LABEL = create_user_embedding(TEST_DATA, MODEL, TOKENIZER)
